...
public class DU
{
    ...
    public static long compareWithToday( String date, String format )
    {
        ...
        double dayUnitDiff = ( comparedCal.getTimeInMillis() - nowCal.getTimeInMillis() )
    ...
    public static long compareWithAnotherDay( String date, String format, String anotherDay, String anotherFormat )
    {
        ...
        double dayUnitDiff = ( comparedCal.getTimeInMillis() - anotherCal.getTimeInMillis() )
            / (double) ( MILLISECOND_OF_DAY );
     ...
     */
    public static long compareStringTime( String preTimeOperand, String preTimeFmt, String postTimeOperand,
                                          String postTimeFmt )
    {
        // TODO 이동규 리팩토링
     ...
     * @return
     */
    public static String compareStringTime( String preTimeOperand, String preTimeFmt, String postTimeOperand,
                                            String postTimeFmt, String translatedFmt )
    {

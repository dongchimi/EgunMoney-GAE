...
public class AccountItemResource
{
    ...
    public JSONResponse register( @FormParam("moneyDivision") String moneyDivision,
                                  @FormParam("useDate") String useDate, @FormParam("because") String because,
                                  @FormParam("amount") String amount, @FormParam("categoryOid") String categoryOid,
                                  @FormParam("targetOid") String targetOid, @FormParam("assetOid") String assetOid,
                                  @FormParam("description") String description,
                                  @FormParam("installmentPlan") String installmentPlan, @FormParam("tags") String tags )
    {
